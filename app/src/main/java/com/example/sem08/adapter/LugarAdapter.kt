...
class LugarAdapter: RecyclerView.Adapter<LugarAdapter.LugarViewHolder>() {
    ...
    inner class LugarViewHolder(private val itemBinding: FragmentLugarFilaBinding ) : RecyclerView.ViewHolder(itemBinding.root){
        fun dibujar(lugar:Lugar){
            ...
            //Glide.with(itemBinding.root.context).load(lugar.rutaImagen).into(itemBinding.imagen)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): LugarViewHolder {
        val itemBinding = FragmentLugarFilaBinding.inflate(LayoutInflater.from(parent.context)
        ,parent,false)
